---
title: UIScreenEventCompData (Frostbite Container)
---
### Base Classes
...
| UIScreenEventCompData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [UIScreenEventCompData](UIScreenEventCompData). |

## Methods

| Type                                           | Name            | Parameters                                     |
| ---------------------------------------------- | --------------- | ---------------------------------------------- |
| [UIScreenEventCompData](UIScreenEventCompData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [UIScreenEventCompData](UIScreenEventCompData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
