---
title: LanPresenceBackendData (Frostbite Container)
---
### Base Classes
...
| LanPresenceBackendData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [LanPresenceBackendData](LanPresenceBackendData). |

## Methods

| Type                                             | Name            | Parameters                                     |
| ------------------------------------------------ | --------------- | ---------------------------------------------- |
| [LanPresenceBackendData](LanPresenceBackendData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [LanPresenceBackendData](LanPresenceBackendData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
