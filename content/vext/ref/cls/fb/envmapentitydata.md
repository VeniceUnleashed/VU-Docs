---
title: EnvmapEntityData (Frostbite Container)
---
### Base Classes
...
| EnvmapEntityData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [EnvmapEntityData](EnvmapEntityData). |

## Methods

| Type                                 | Name            | Parameters                                     |
| ------------------------------------ | --------------- | ---------------------------------------------- |
| [EnvmapEntityData](EnvmapEntityData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [EnvmapEntityData](EnvmapEntityData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
