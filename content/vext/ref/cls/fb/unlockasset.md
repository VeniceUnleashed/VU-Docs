---
title: UnlockAsset (Frostbite Container)
---
### Base Classes
...
| UnlockAsset([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [UnlockAsset](UnlockAsset). |
...
| -------------------------- | --------------- | ---------------------------------------------- |
| [UnlockAsset](UnlockAsset) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [UnlockAsset](UnlockAsset) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
