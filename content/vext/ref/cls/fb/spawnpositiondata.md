---
title: SpawnPositionData (Frostbite Container)
---
### Base Classes
...
| SpawnPositionData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [SpawnPositionData](SpawnPositionData). |

## Methods

| Type                                   | Name            | Parameters                                     |
| -------------------------------------- | --------------- | ---------------------------------------------- |
| [SpawnPositionData](SpawnPositionData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [SpawnPositionData](SpawnPositionData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
