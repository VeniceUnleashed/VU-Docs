---
title: IrReverbControllerNodeData (Frostbite Container)
---
### Base Classes
...
| IrReverbControllerNodeData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [IrReverbControllerNodeData](IrReverbControllerNodeData). |
...
| -------------------------------------------------------- | --------------- | ---------------------------------------------- |
| [IrReverbControllerNodeData](IrReverbControllerNodeData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [IrReverbControllerNodeData](IrReverbControllerNodeData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
