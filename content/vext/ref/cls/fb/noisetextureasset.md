---
title: NoiseTextureAsset (Frostbite Container)
---
### Base Classes
...
| NoiseTextureAsset([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [NoiseTextureAsset](NoiseTextureAsset). |

## Methods

| Type                                   | Name            | Parameters                                     |
| -------------------------------------- | --------------- | ---------------------------------------------- |
| [NoiseTextureAsset](NoiseTextureAsset) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [NoiseTextureAsset](NoiseTextureAsset) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
