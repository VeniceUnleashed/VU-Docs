---
title: BoolEntityData (Frostbite Container)
---
### Base Classes
...
| BoolEntityData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [BoolEntityData](BoolEntityData). |
...
| -------------------------------- | --------------- | ---------------------------------------------- |
| [BoolEntityData](BoolEntityData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [BoolEntityData](BoolEntityData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
