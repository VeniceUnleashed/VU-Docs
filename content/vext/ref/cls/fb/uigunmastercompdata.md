---
title: UIGunMasterCompData (Frostbite Container)
---
### Base Classes
...
| UIGunMasterCompData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [UIGunMasterCompData](UIGunMasterCompData). |

## Methods

| Type                                       | Name            | Parameters                                     |
| ------------------------------------------ | --------------- | ---------------------------------------------- |
| [UIGunMasterCompData](UIGunMasterCompData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [UIGunMasterCompData](UIGunMasterCompData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
