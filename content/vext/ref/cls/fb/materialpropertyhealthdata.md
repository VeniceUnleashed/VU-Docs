---
title: MaterialPropertyHealthData (Frostbite Container)
---
### Base Classes
...
| MaterialPropertyHealthData([DataContainer](/vext/ref/cls/shr/datacontainer) other)                        | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [MaterialPropertyHealthData](MaterialPropertyHealthData).                        |
...
| -------------------------------------------------------- | --------------- | ---------------------------------------------- |
| [MaterialPropertyHealthData](MaterialPropertyHealthData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [MaterialPropertyHealthData](MaterialPropertyHealthData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
