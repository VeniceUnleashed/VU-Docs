---
title: UISpawnPointCompData (Frostbite Container)
---
### Base Classes
...
| UISpawnPointCompData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [UISpawnPointCompData](UISpawnPointCompData). |

## Methods

| Type                                         | Name            | Parameters                                     |
| -------------------------------------------- | --------------- | ---------------------------------------------- |
| [UISpawnPointCompData](UISpawnPointCompData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [UISpawnPointCompData](UISpawnPointCompData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
