---
title: BandPassIir2NodeData (Frostbite Container)
---
### Base Classes
...
| BandPassIir2NodeData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [BandPassIir2NodeData](BandPassIir2NodeData). |
...
| -------------------------------------------- | --------------- | ---------------------------------------------- |
| [BandPassIir2NodeData](BandPassIir2NodeData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [BandPassIir2NodeData](BandPassIir2NodeData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
