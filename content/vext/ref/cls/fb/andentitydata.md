---
title: AndEntityData (Frostbite Container)
---
### Base Classes
...
| AndEntityData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [AndEntityData](AndEntityData). |
...
| ------------------------------ | --------------- | ---------------------------------------------- |
| [AndEntityData](AndEntityData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [AndEntityData](AndEntityData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
