---
title: StatCategoriesLevelTree (Frostbite Container)
---
### Base Classes
...
| StatCategoriesLevelTree([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [StatCategoriesLevelTree](StatCategoriesLevelTree). |

## Methods

| Type                                               | Name            | Parameters                                     |
| -------------------------------------------------- | --------------- | ---------------------------------------------- |
| [StatCategoriesLevelTree](StatCategoriesLevelTree) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [StatCategoriesLevelTree](StatCategoriesLevelTree) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
