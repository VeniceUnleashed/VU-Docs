---
title: UIGraphAsset (Frostbite Container)
---
### Base Classes
...
| UIGraphAsset([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [UIGraphAsset](UIGraphAsset). |
...
| ---------------------------- | --------------- | ---------------------------------------------- |
| [UIGraphAsset](UIGraphAsset) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [UIGraphAsset](UIGraphAsset) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
