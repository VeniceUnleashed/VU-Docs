---
title: GainNodeData (Frostbite Container)
---
### Base Classes
...
| GainNodeData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [GainNodeData](GainNodeData). |
...
| ---------------------------- | --------------- | ---------------------------------------------- |
| [GainNodeData](GainNodeData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [GainNodeData](GainNodeData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
