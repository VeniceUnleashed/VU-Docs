---
title: HealthComponentData (Frostbite Container)
---
### Base Classes
...
| HealthComponentData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [HealthComponentData](HealthComponentData). |
...
| ------------------------------------------ | --------------- | ---------------------------------------------- |
| [HealthComponentData](HealthComponentData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [HealthComponentData](HealthComponentData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
