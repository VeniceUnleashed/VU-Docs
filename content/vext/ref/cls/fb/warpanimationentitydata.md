---
title: WarpAnimationEntityData (Frostbite Container)
---
### Base Classes
...
| WarpAnimationEntityData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [WarpAnimationEntityData](WarpAnimationEntityData). |
...
| -------------------------------------------------- | --------------- | ---------------------------------------------- |
| [WarpAnimationEntityData](WarpAnimationEntityData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [WarpAnimationEntityData](WarpAnimationEntityData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
