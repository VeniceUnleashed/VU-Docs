---
title: VoiceOverDistanceNode (Frostbite Container)
---
### Base Classes
...
| VoiceOverDistanceNode([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [VoiceOverDistanceNode](VoiceOverDistanceNode). |
...
| ---------------------------------------------- | --------------- | ---------------------------------------------- |
| [VoiceOverDistanceNode](VoiceOverDistanceNode) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [VoiceOverDistanceNode](VoiceOverDistanceNode) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
