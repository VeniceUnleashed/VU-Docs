---
title: MaterialRelationSoundData (Frostbite Container)
---
### Base Classes
...
| MaterialRelationSoundData([DataContainer](/vext/ref/cls/shr/datacontainer) other)                        | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [MaterialRelationSoundData](MaterialRelationSoundData).                        |
...
| ------------------------------------------------------ | --------------- | ---------------------------------------------- |
| [MaterialRelationSoundData](MaterialRelationSoundData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [MaterialRelationSoundData](MaterialRelationSoundData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
