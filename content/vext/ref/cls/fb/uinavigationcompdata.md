---
title: UINavigationCompData (Frostbite Container)
---
### Base Classes
...
| UINavigationCompData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [UINavigationCompData](UINavigationCompData). |

## Methods

| Type                                         | Name            | Parameters                                     |
| -------------------------------------------- | --------------- | ---------------------------------------------- |
| [UINavigationCompData](UINavigationCompData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [UINavigationCompData](UINavigationCompData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
