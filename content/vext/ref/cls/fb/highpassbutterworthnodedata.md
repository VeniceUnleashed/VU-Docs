---
title: HighPassButterworthNodeData (Frostbite Container)
---
### Base Classes
...
| HighPassButterworthNodeData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [HighPassButterworthNodeData](HighPassButterworthNodeData). |
...
| ---------------------------------------------------------- | --------------- | ---------------------------------------------- |
| [HighPassButterworthNodeData](HighPassButterworthNodeData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [HighPassButterworthNodeData](HighPassButterworthNodeData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
