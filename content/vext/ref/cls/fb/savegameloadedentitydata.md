---
title: SaveGameLoadedEntityData (Frostbite Container)
---
### Base Classes
...
| SaveGameLoadedEntityData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [SaveGameLoadedEntityData](SaveGameLoadedEntityData). |

## Methods

| Type                                                 | Name            | Parameters                                     |
| ---------------------------------------------------- | --------------- | ---------------------------------------------- |
| [SaveGameLoadedEntityData](SaveGameLoadedEntityData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [SaveGameLoadedEntityData](SaveGameLoadedEntityData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
