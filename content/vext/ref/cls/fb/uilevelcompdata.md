---
title: UILevelCompData (Frostbite Container)
---
### Base Classes
...
| UILevelCompData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [UILevelCompData](UILevelCompData). |

## Methods

| Type                               | Name            | Parameters                                     |
| ---------------------------------- | --------------- | ---------------------------------------------- |
| [UILevelCompData](UILevelCompData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [UILevelCompData](UILevelCompData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
