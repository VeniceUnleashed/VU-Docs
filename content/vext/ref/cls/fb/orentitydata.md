---
title: OrEntityData (Frostbite Container)
---
### Base Classes
...
| OrEntityData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [OrEntityData](OrEntityData). |
...
| ---------------------------- | --------------- | ---------------------------------------------- |
| [OrEntityData](OrEntityData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [OrEntityData](OrEntityData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
