---
title: MinMaxNodeData (Frostbite Container)
---
### Base Classes
...
| MinMaxNodeData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [MinMaxNodeData](MinMaxNodeData). |
...
| -------------------------------- | --------------- | ---------------------------------------------- |
| [MinMaxNodeData](MinMaxNodeData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [MinMaxNodeData](MinMaxNodeData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
