---
title: ProfileOptionDataEnum (Frostbite Container)
---
### Base Classes
...
| ProfileOptionDataEnum([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [ProfileOptionDataEnum](ProfileOptionDataEnum). |
...
| ---------------------------------------------- | --------------- | ---------------------------------------------- |
| [ProfileOptionDataEnum](ProfileOptionDataEnum) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [ProfileOptionDataEnum](ProfileOptionDataEnum) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
