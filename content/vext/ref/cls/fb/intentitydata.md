---
title: IntEntityData (Frostbite Container)
---
### Base Classes
...
| IntEntityData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [IntEntityData](IntEntityData). |
...
| ------------------------------ | --------------- | ---------------------------------------------- |
| [IntEntityData](IntEntityData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [IntEntityData](IntEntityData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
