---
title: StaticEnlightenData (Frostbite Container)
---
### Base Classes
...
| StaticEnlightenData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [StaticEnlightenData](StaticEnlightenData). |
...
| ------------------------------------------ | --------------- | ---------------------------------------------- |
| [StaticEnlightenData](StaticEnlightenData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [StaticEnlightenData](StaticEnlightenData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
