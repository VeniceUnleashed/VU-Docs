---
title: MovieComponentData (Frostbite Container)
---
### Base Classes
...
| MovieComponentData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [MovieComponentData](MovieComponentData). |
...
| ---------------------------------------- | --------------- | ---------------------------------------------- |
| [MovieComponentData](MovieComponentData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [MovieComponentData](MovieComponentData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
