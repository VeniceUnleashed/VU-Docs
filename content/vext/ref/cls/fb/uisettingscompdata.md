---
title: UISettingsCompData (Frostbite Container)
---
### Base Classes
...
| UISettingsCompData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [UISettingsCompData](UISettingsCompData). |
...
| ---------------------------------------- | --------------- | ---------------------------------------------- |
| [UISettingsCompData](UISettingsCompData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [UISettingsCompData](UISettingsCompData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
