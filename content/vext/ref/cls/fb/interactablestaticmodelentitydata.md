---
title: InteractableStaticModelEntityData (Frostbite Container)
---
### Base Classes
...
| InteractableStaticModelEntityData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [InteractableStaticModelEntityData](InteractableStaticModelEntityData). |

## Methods

| Type                                                                   | Name            | Parameters                                     |
| ---------------------------------------------------------------------- | --------------- | ---------------------------------------------- |
| [InteractableStaticModelEntityData](InteractableStaticModelEntityData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [InteractableStaticModelEntityData](InteractableStaticModelEntityData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
