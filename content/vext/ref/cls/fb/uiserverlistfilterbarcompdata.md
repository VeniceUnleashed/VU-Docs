---
title: UIServerListFilterBarCompData (Frostbite Container)
---
### Base Classes
...
| UIServerListFilterBarCompData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [UIServerListFilterBarCompData](UIServerListFilterBarCompData). |

## Methods

| Type                                                           | Name            | Parameters                                     |
| -------------------------------------------------------------- | --------------- | ---------------------------------------------- |
| [UIServerListFilterBarCompData](UIServerListFilterBarCompData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [UIServerListFilterBarCompData](UIServerListFilterBarCompData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
