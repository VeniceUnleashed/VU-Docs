---
title: UILifeCounterCompData (Frostbite Container)
---
### Base Classes
...
| UILifeCounterCompData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [UILifeCounterCompData](UILifeCounterCompData). |

## Methods

| Type                                           | Name            | Parameters                                     |
| ---------------------------------------------- | --------------- | ---------------------------------------------- |
| [UILifeCounterCompData](UILifeCounterCompData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [UILifeCounterCompData](UILifeCounterCompData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
