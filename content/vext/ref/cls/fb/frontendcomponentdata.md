---
title: FrontEndComponentData (Frostbite Container)
---
### Base Classes
...
| FrontEndComponentData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [FrontEndComponentData](FrontEndComponentData). |

## Methods

| Type                                           | Name            | Parameters                                     |
| ---------------------------------------------- | --------------- | ---------------------------------------------- |
| [FrontEndComponentData](FrontEndComponentData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [FrontEndComponentData](FrontEndComponentData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
