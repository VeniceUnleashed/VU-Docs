---
title: SoundStateEntityData (Frostbite Container)
---
### Base Classes
...
| SoundStateEntityData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [SoundStateEntityData](SoundStateEntityData). |
...
| -------------------------------------------- | --------------- | ---------------------------------------------- |
| [SoundStateEntityData](SoundStateEntityData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [SoundStateEntityData](SoundStateEntityData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
