---
title: UIChatCompData (Frostbite Container)
---
### Base Classes
...
| UIChatCompData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [UIChatCompData](UIChatCompData). |
...
| -------------------------------- | --------------- | ---------------------------------------------- |
| [UIChatCompData](UIChatCompData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [UIChatCompData](UIChatCompData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
