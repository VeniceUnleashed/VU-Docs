---
title: XorEntityData (Frostbite Container)
---
### Base Classes
...
| XorEntityData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [XorEntityData](XorEntityData). |
...
| ------------------------------ | --------------- | ---------------------------------------------- |
| [XorEntityData](XorEntityData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [XorEntityData](XorEntityData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
