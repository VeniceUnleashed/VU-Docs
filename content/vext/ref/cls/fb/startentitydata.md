---
title: StartEntityData (Frostbite Container)
---
### Base Classes
...
| StartEntityData([DataContainer](/vext/ref/cls/shr/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/cls/shr/datacontainer) to [StartEntityData](StartEntityData). |
...
| ---------------------------------- | --------------- | ---------------------------------------------- |
| [StartEntityData](StartEntityData) | [Clone](#clone) | \[[Guid](/vext/ref/cls/shr/guid) **guid**\] |

### Clone

> [StartEntityData](StartEntityData) **Clone**(\[[Guid](/vext/ref/cls/shr/guid) **guid**\])
