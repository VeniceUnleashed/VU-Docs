...
| **[BulletEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/class/guid)) |
...
| **[BulletEntityData](#constructor-10)**(other: [DataContainer](/vext/ref/shared/class/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "BulletEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/class/typeinformation) |
...
> **BulletEntityData**(guid: [Guid](/vext/ref/shared/class/guid))

Creates a new [BulletEntityData](/vext/ref/fb/bulletentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/class/guid).
...
Casts an instance of type [MeshProjectileEntityData](/vext/ref/fb/meshprojectileentitydata) to [BulletEntityData](/vext/ref/fb/bulletentitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [ProjectileEntityData](/vext/ref/fb/projectileentitydata) to [BulletEntityData](/vext/ref/fb/bulletentitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [GamePhysicsEntityData](/vext/ref/fb/gamephysicsentitydata) to [BulletEntityData](/vext/ref/fb/bulletentitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [GameEntityData](/vext/ref/fb/gameentitydata) to [BulletEntityData](/vext/ref/fb/bulletentitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [SpatialEntityData](/vext/ref/fb/spatialentitydata) to [BulletEntityData](/vext/ref/fb/bulletentitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [BulletEntityData](/vext/ref/fb/bulletentitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [BulletEntityData](/vext/ref/fb/bulletentitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [BulletEntityData](/vext/ref/fb/bulletentitydata). Will throw an error when trying to cast from an invalid type.
...
> **BulletEntityData**(other: [DataContainer](/vext/ref/shared/class/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [BulletEntityData](/vext/ref/fb/bulletentitydata). Will throw an error when trying to cast from an invalid type.

#### Parameters
| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/class/datacontainer) | The instance to cast to [BulletEntityData](/vext/ref/fb/bulletentitydata). |
