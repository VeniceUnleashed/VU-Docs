...
| **[AnimationSignalEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[AnimationSignalEntityData](#constructor-5)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "AnimationSignalEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **AnimationSignalEntityData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [AnimationSignalEntityData](/vext/ref/fb/animationsignalentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [AnimationSignalEntityData](/vext/ref/fb/animationsignalentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [AnimationSignalEntityData](/vext/ref/fb/animationsignalentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [AnimationSignalEntityData](/vext/ref/fb/animationsignalentitydata). Will throw an error when trying to cast from an unsupported type.
...
> **AnimationSignalEntityData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [AnimationSignalEntityData](/vext/ref/fb/animationsignalentitydata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [AnimationSignalEntityData](/vext/ref/fb/animationsignalentitydata). |
