...
| WaypointTriggerEntityData([DataContainer](/vext/ref/shared/class/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [WaypointTriggerEntityData](WaypointTriggerEntityData). |
...
| ------------------------------------------------------ | --------------- | ---------------------------------------------- |
| [WaypointTriggerEntityData](WaypointTriggerEntityData) | [Clone](#clone) | \[[Guid](/vext/ref/shared/class/guid) **guid**\] |

### Clone

> [WaypointTriggerEntityData](WaypointTriggerEntityData) **Clone**(\[[Guid](/vext/ref/shared/class/guid) **guid**\])
