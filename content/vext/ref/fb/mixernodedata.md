...
| MixerNodeData([DataContainer](/vext/ref/shared/class/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [MixerNodeData](MixerNodeData). |
...
| ------------------------------ | --------------- | ---------------------------------------------- |
| [MixerNodeData](MixerNodeData) | [Clone](#clone) | \[[Guid](/vext/ref/shared/class/guid) **guid**\] |

### Clone

> [MixerNodeData](MixerNodeData) **Clone**(\[[Guid](/vext/ref/shared/class/guid) **guid**\])
