...
| WeaponMagazineModifier([DataContainer](/vext/ref/shared/class/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [WeaponMagazineModifier](WeaponMagazineModifier). |
...
| ------------------------------------------------ | --------------- | ---------------------------------------------- |
| [WeaponMagazineModifier](WeaponMagazineModifier) | [Clone](#clone) | \[[Guid](/vext/ref/shared/class/guid) **guid**\] |

### Clone

> [WeaponMagazineModifier](WeaponMagazineModifier) **Clone**(\[[Guid](/vext/ref/shared/class/guid) **guid**\])
