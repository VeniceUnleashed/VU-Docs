...
| **[MessageEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[MessageEntityData](#constructor-5)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "MessageEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **MessageEntityData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [MessageEntityData](/vext/ref/fb/messageentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [MessageEntityData](/vext/ref/fb/messageentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [MessageEntityData](/vext/ref/fb/messageentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [MessageEntityData](/vext/ref/fb/messageentitydata). Will throw an error when trying to cast from an unsupported type.
...
> **MessageEntityData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [MessageEntityData](/vext/ref/fb/messageentitydata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [MessageEntityData](/vext/ref/fb/messageentitydata). |
