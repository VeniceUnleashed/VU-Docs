...
| **[DamageAreaTriggerEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[DamageAreaTriggerEntityData](#constructor-8)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "DamageAreaTriggerEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **DamageAreaTriggerEntityData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [DamageAreaTriggerEntityData](/vext/ref/fb/damageareatriggerentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [TriggerEntityData](/vext/ref/fb/triggerentitydata) to [DamageAreaTriggerEntityData](/vext/ref/fb/damageareatriggerentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameEntityData](/vext/ref/fb/gameentitydata) to [DamageAreaTriggerEntityData](/vext/ref/fb/damageareatriggerentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [SpatialEntityData](/vext/ref/fb/spatialentitydata) to [DamageAreaTriggerEntityData](/vext/ref/fb/damageareatriggerentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [DamageAreaTriggerEntityData](/vext/ref/fb/damageareatriggerentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [DamageAreaTriggerEntityData](/vext/ref/fb/damageareatriggerentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [DamageAreaTriggerEntityData](/vext/ref/fb/damageareatriggerentitydata). Will throw an error when trying to cast from an unsupported type.
...
> **DamageAreaTriggerEntityData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [DamageAreaTriggerEntityData](/vext/ref/fb/damageareatriggerentitydata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [DamageAreaTriggerEntityData](/vext/ref/fb/damageareatriggerentitydata). |
