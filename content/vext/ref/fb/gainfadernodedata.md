...
| **[GainFaderNodeData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
| **[GainFaderNodeData](#constructor-2)**(other: [AudioGraphNodeData](/vext/ref/fb/audiographnodedata)) |
| **[GainFaderNodeData](#constructor-3)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "GainFaderNodeData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **GainFaderNodeData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [GainFaderNodeData](/vext/ref/fb/gainfadernodedata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [AudioGraphNodeData](/vext/ref/fb/audiographnodedata) to [GainFaderNodeData](/vext/ref/fb/gainfadernodedata). Will throw an error when trying to cast from an unsupported type.
...
> **GainFaderNodeData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [GainFaderNodeData](/vext/ref/fb/gainfadernodedata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [GainFaderNodeData](/vext/ref/fb/gainfadernodedata). |
