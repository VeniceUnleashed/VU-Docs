...
| **[FollowWaypointsEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[FollowWaypointsEntityData](#constructor-5)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "FollowWaypointsEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **FollowWaypointsEntityData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [FollowWaypointsEntityData](/vext/ref/fb/followwaypointsentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [FollowWaypointsEntityData](/vext/ref/fb/followwaypointsentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [FollowWaypointsEntityData](/vext/ref/fb/followwaypointsentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [FollowWaypointsEntityData](/vext/ref/fb/followwaypointsentitydata). Will throw an error when trying to cast from an unsupported type.
...
> **FollowWaypointsEntityData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [FollowWaypointsEntityData](/vext/ref/fb/followwaypointsentitydata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [FollowWaypointsEntityData](/vext/ref/fb/followwaypointsentitydata). |
