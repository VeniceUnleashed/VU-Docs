...
| **[FireLogicData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "FireLogicData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
Creates a new [FireLogicData](/vext/ref/fb/firelogicdata) frostbite instance.

### FireLogicData {#constructor-1}

> **FireLogicData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [FireLogicData](/vext/ref/fb/firelogicdata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
