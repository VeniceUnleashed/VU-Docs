...
| **[CharacterStateTriggerEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[CharacterStateTriggerEntityData](#constructor-8)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "CharacterStateTriggerEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **CharacterStateTriggerEntityData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [CharacterStateTriggerEntityData](/vext/ref/fb/characterstatetriggerentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [TriggerEntityData](/vext/ref/fb/triggerentitydata) to [CharacterStateTriggerEntityData](/vext/ref/fb/characterstatetriggerentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameEntityData](/vext/ref/fb/gameentitydata) to [CharacterStateTriggerEntityData](/vext/ref/fb/characterstatetriggerentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [SpatialEntityData](/vext/ref/fb/spatialentitydata) to [CharacterStateTriggerEntityData](/vext/ref/fb/characterstatetriggerentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [CharacterStateTriggerEntityData](/vext/ref/fb/characterstatetriggerentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [CharacterStateTriggerEntityData](/vext/ref/fb/characterstatetriggerentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [CharacterStateTriggerEntityData](/vext/ref/fb/characterstatetriggerentitydata). Will throw an error when trying to cast from an unsupported type.
...
> **CharacterStateTriggerEntityData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [CharacterStateTriggerEntityData](/vext/ref/fb/characterstatetriggerentitydata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [CharacterStateTriggerEntityData](/vext/ref/fb/characterstatetriggerentitydata). |
