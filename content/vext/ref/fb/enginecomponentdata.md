...
| **[EngineComponentData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[EngineComponentData](#constructor-5)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "EngineComponentData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **EngineComponentData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [EngineComponentData](/vext/ref/fb/enginecomponentdata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [ComponentData](/vext/ref/fb/componentdata) to [EngineComponentData](/vext/ref/fb/enginecomponentdata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [EngineComponentData](/vext/ref/fb/enginecomponentdata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [EngineComponentData](/vext/ref/fb/enginecomponentdata). Will throw an error when trying to cast from an unsupported type.
...
> **EngineComponentData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [EngineComponentData](/vext/ref/fb/enginecomponentdata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [EngineComponentData](/vext/ref/fb/enginecomponentdata). |
