...
| **[DxDisplaySettings](#constructor-1)**(guid: [Guid](/vext/ref/shared/class/guid)) |
| **[DxDisplaySettings](#constructor-2)**(other: [SystemSettings](/vext/ref/fb/systemsettings)) |
| **[DxDisplaySettings](#constructor-3)**(other: [DataContainer](/vext/ref/shared/class/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "DxDisplaySettings" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/class/typeinformation) |
...
> **DxDisplaySettings**(guid: [Guid](/vext/ref/shared/class/guid))

Creates a new [DxDisplaySettings](/vext/ref/fb/dxdisplaysettings) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/class/guid).
...
Casts an instance of type [SystemSettings](/vext/ref/fb/systemsettings) to [DxDisplaySettings](/vext/ref/fb/dxdisplaysettings). Will throw an error when trying to cast from an invalid type.
...
> **DxDisplaySettings**(other: [DataContainer](/vext/ref/shared/class/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [DxDisplaySettings](/vext/ref/fb/dxdisplaysettings). Will throw an error when trying to cast from an invalid type.

#### Parameters
| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/class/datacontainer) | The instance to cast to [DxDisplaySettings](/vext/ref/fb/dxdisplaysettings). |
