...
| **[ClientEffectMaskVolumeEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[ClientEffectMaskVolumeEntityData](#constructor-7)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |

### Properties

| Name | Type |
| ---- | ---- |
| {{< prop "applyEffectCurve" >}} | [Vec4](/vext/ref/shared/type/vec4) |
...
| Name | Type |
| ---- | ---- |
| {{< static "ClientEffectMaskVolumeEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **ClientEffectMaskVolumeEntityData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [ClientEffectMaskVolumeEntityData](/vext/ref/fb/clienteffectmaskvolumeentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [GameEntityData](/vext/ref/fb/gameentitydata) to [ClientEffectMaskVolumeEntityData](/vext/ref/fb/clienteffectmaskvolumeentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [SpatialEntityData](/vext/ref/fb/spatialentitydata) to [ClientEffectMaskVolumeEntityData](/vext/ref/fb/clienteffectmaskvolumeentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [ClientEffectMaskVolumeEntityData](/vext/ref/fb/clienteffectmaskvolumeentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [ClientEffectMaskVolumeEntityData](/vext/ref/fb/clienteffectmaskvolumeentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [ClientEffectMaskVolumeEntityData](/vext/ref/fb/clienteffectmaskvolumeentitydata). Will throw an error when trying to cast from an unsupported type.
...
> **ClientEffectMaskVolumeEntityData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [ClientEffectMaskVolumeEntityData](/vext/ref/fb/clienteffectmaskvolumeentitydata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [ClientEffectMaskVolumeEntityData](/vext/ref/fb/clienteffectmaskvolumeentitydata). |
