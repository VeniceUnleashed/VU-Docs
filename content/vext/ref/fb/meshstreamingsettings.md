...
| **[MeshStreamingSettings](#constructor-1)**(guid: [Guid](/vext/ref/shared/class/guid)) |
| **[MeshStreamingSettings](#constructor-2)**(other: [DataContainer](/vext/ref/shared/class/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "MeshStreamingSettings" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/class/typeinformation) |
...
> **MeshStreamingSettings**(guid: [Guid](/vext/ref/shared/class/guid))

Creates a new [MeshStreamingSettings](/vext/ref/fb/meshstreamingsettings) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/class/guid).
...
> **MeshStreamingSettings**(other: [DataContainer](/vext/ref/shared/class/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [MeshStreamingSettings](/vext/ref/fb/meshstreamingsettings). Will throw an error when trying to cast from an invalid type.

#### Parameters
| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/class/datacontainer) | The instance to cast to [MeshStreamingSettings](/vext/ref/fb/meshstreamingsettings). |
