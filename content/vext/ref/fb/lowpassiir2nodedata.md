...
| LowPassIir2NodeData([DataContainer](/vext/ref/shared/class/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [LowPassIir2NodeData](LowPassIir2NodeData). |
...
| ------------------------------------------ | --------------- | ---------------------------------------------- |
| [LowPassIir2NodeData](LowPassIir2NodeData) | [Clone](#clone) | \[[Guid](/vext/ref/shared/class/guid) **guid**\] |

### Clone

> [LowPassIir2NodeData](LowPassIir2NodeData) **Clone**(\[[Guid](/vext/ref/shared/class/guid) **guid**\])
