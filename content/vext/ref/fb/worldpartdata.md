...
| **[WorldPartData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[WorldPartData](#constructor-8)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "WorldPartData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **WorldPartData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [WorldPartData](/vext/ref/fb/worldpartdata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [SpatialPrefabBlueprint](/vext/ref/fb/spatialprefabblueprint) to [WorldPartData](/vext/ref/fb/worldpartdata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [PrefabBlueprint](/vext/ref/fb/prefabblueprint) to [WorldPartData](/vext/ref/fb/worldpartdata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [Blueprint](/vext/ref/fb/blueprint) to [WorldPartData](/vext/ref/fb/worldpartdata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [EntityBusData](/vext/ref/fb/entitybusdata) to [WorldPartData](/vext/ref/fb/worldpartdata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [DataBusData](/vext/ref/fb/databusdata) to [WorldPartData](/vext/ref/fb/worldpartdata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [Asset](/vext/ref/fb/asset) to [WorldPartData](/vext/ref/fb/worldpartdata). Will throw an error when trying to cast from an unsupported type.
...
> **WorldPartData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [WorldPartData](/vext/ref/fb/worldpartdata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [WorldPartData](/vext/ref/fb/worldpartdata). |
