...
| **[TimingViewSettings](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
| **[TimingViewSettings](#constructor-2)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "TimingViewSettings" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **TimingViewSettings**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [TimingViewSettings](/vext/ref/fb/timingviewsettings) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
> **TimingViewSettings**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [TimingViewSettings](/vext/ref/fb/timingviewsettings). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [TimingViewSettings](/vext/ref/fb/timingviewsettings). |
