...
| **[EventCompareGateEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[EventCompareGateEntityData](#constructor-5)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "EventCompareGateEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **EventCompareGateEntityData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [EventCompareGateEntityData](/vext/ref/fb/eventcomparegateentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [EventCompareGateEntityData](/vext/ref/fb/eventcomparegateentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [EventCompareGateEntityData](/vext/ref/fb/eventcomparegateentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [EventCompareGateEntityData](/vext/ref/fb/eventcomparegateentitydata). Will throw an error when trying to cast from an unsupported type.
...
> **EventCompareGateEntityData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [EventCompareGateEntityData](/vext/ref/fb/eventcomparegateentitydata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [EventCompareGateEntityData](/vext/ref/fb/eventcomparegateentitydata). |
