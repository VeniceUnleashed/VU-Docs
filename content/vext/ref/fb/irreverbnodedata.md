...
| **[IrReverbNodeData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
| **[IrReverbNodeData](#constructor-2)**(other: [AudioGraphNodeData](/vext/ref/fb/audiographnodedata)) |
| **[IrReverbNodeData](#constructor-3)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "IrReverbNodeData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **IrReverbNodeData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [IrReverbNodeData](/vext/ref/fb/irreverbnodedata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [AudioGraphNodeData](/vext/ref/fb/audiographnodedata) to [IrReverbNodeData](/vext/ref/fb/irreverbnodedata). Will throw an error when trying to cast from an unsupported type.
...
> **IrReverbNodeData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [IrReverbNodeData](/vext/ref/fb/irreverbnodedata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [IrReverbNodeData](/vext/ref/fb/irreverbnodedata). |
