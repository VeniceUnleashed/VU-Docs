...
| **[GameRenderSettings](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
| **[GameRenderSettings](#constructor-2)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "GameRenderSettings" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **GameRenderSettings**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [GameRenderSettings](/vext/ref/fb/gamerendersettings) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
> **GameRenderSettings**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [GameRenderSettings](/vext/ref/fb/gamerendersettings). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [GameRenderSettings](/vext/ref/fb/gamerendersettings). |
