...
Inherits from [GameAIWeaponData](/vext/ref/fb/gameaiweapondata)
...
| **[AIWeaponData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[AIWeaponData](#constructor-4)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "AIWeaponData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **AIWeaponData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [AIWeaponData](/vext/ref/fb/aiweapondata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [GameAIWeaponData](/vext/ref/fb/gameaiweapondata) to [AIWeaponData](/vext/ref/fb/aiweapondata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [Asset](/vext/ref/fb/asset) to [AIWeaponData](/vext/ref/fb/aiweapondata). Will throw an error when trying to cast from an unsupported type.
...
> **AIWeaponData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [AIWeaponData](/vext/ref/fb/aiweapondata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [AIWeaponData](/vext/ref/fb/aiweapondata). |
