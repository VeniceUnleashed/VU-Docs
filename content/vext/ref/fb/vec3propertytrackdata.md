...
| Vec3PropertyTrackData([DataContainer](/vext/ref/shared/class/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [Vec3PropertyTrackData](Vec3PropertyTrackData). |
...
| ---------------------------------------------- | --------------- | ---------------------------------------------- |
| [Vec3PropertyTrackData](Vec3PropertyTrackData) | [Clone](#clone) | \[[Guid](/vext/ref/shared/class/guid) **guid**\] |

### Clone

> [Vec3PropertyTrackData](Vec3PropertyTrackData) **Clone**(\[[Guid](/vext/ref/shared/class/guid) **guid**\])
