...
| **[LimiterNodeData](#constructor-1)**(guid: [Guid](/vext/ref/shared/class/guid)) |
| **[LimiterNodeData](#constructor-2)**(other: [AudioGraphNodeData](/vext/ref/fb/audiographnodedata)) |
| **[LimiterNodeData](#constructor-3)**(other: [DataContainer](/vext/ref/shared/class/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "LimiterNodeData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/class/typeinformation) |
...
> **LimiterNodeData**(guid: [Guid](/vext/ref/shared/class/guid))

Creates a new [LimiterNodeData](/vext/ref/fb/limiternodedata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/class/guid).
...
Casts an instance of type [AudioGraphNodeData](/vext/ref/fb/audiographnodedata) to [LimiterNodeData](/vext/ref/fb/limiternodedata). Will throw an error when trying to cast from an invalid type.
...
> **LimiterNodeData**(other: [DataContainer](/vext/ref/shared/class/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [LimiterNodeData](/vext/ref/fb/limiternodedata). Will throw an error when trying to cast from an invalid type.

#### Parameters
| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/class/datacontainer) | The instance to cast to [LimiterNodeData](/vext/ref/fb/limiternodedata). |
