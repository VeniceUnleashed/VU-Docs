...
| **[FriendZoneEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/class/guid)) |
...
| **[FriendZoneEntityData](#constructor-5)**(other: [DataContainer](/vext/ref/shared/class/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "FriendZoneEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/class/typeinformation) |
...
> **FriendZoneEntityData**(guid: [Guid](/vext/ref/shared/class/guid))

Creates a new [FriendZoneEntityData](/vext/ref/fb/friendzoneentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/class/guid).
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [FriendZoneEntityData](/vext/ref/fb/friendzoneentitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [FriendZoneEntityData](/vext/ref/fb/friendzoneentitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [FriendZoneEntityData](/vext/ref/fb/friendzoneentitydata). Will throw an error when trying to cast from an invalid type.
...
> **FriendZoneEntityData**(other: [DataContainer](/vext/ref/shared/class/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [FriendZoneEntityData](/vext/ref/fb/friendzoneentitydata). Will throw an error when trying to cast from an invalid type.

#### Parameters
| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/class/datacontainer) | The instance to cast to [FriendZoneEntityData](/vext/ref/fb/friendzoneentitydata). |
