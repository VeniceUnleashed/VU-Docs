...
| **[PropellerEngineConfigData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
| **[PropellerEngineConfigData](#constructor-2)**(other: [EngineConfigData](/vext/ref/fb/engineconfigdata)) |
| **[PropellerEngineConfigData](#constructor-3)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |

### Properties

| Name | Type |
| ---- | ---- |
| {{< prop "horisontalForceOffset" >}} | [Vec3](/vext/ref/shared/type/vec3) |
...
| Name | Type |
| ---- | ---- |
| {{< static "PropellerEngineConfigData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **PropellerEngineConfigData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [PropellerEngineConfigData](/vext/ref/fb/propellerengineconfigdata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [EngineConfigData](/vext/ref/fb/engineconfigdata) to [PropellerEngineConfigData](/vext/ref/fb/propellerengineconfigdata). Will throw an error when trying to cast from an unsupported type.
...
> **PropellerEngineConfigData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [PropellerEngineConfigData](/vext/ref/fb/propellerengineconfigdata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [PropellerEngineConfigData](/vext/ref/fb/propellerengineconfigdata). |
