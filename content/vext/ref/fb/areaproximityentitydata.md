...
| **[AreaProximityEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[AreaProximityEntityData](#constructor-5)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "AreaProximityEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **AreaProximityEntityData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [AreaProximityEntityData](/vext/ref/fb/areaproximityentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [AreaProximityEntityData](/vext/ref/fb/areaproximityentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [AreaProximityEntityData](/vext/ref/fb/areaproximityentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [AreaProximityEntityData](/vext/ref/fb/areaproximityentitydata). Will throw an error when trying to cast from an unsupported type.
...
> **AreaProximityEntityData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [AreaProximityEntityData](/vext/ref/fb/areaproximityentitydata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [AreaProximityEntityData](/vext/ref/fb/areaproximityentitydata). |
