...
| **[VeniceHudConfigAsset](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
| **[VeniceHudConfigAsset](#constructor-2)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "VeniceHudConfigAsset" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **VeniceHudConfigAsset**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [VeniceHudConfigAsset](/vext/ref/fb/venicehudconfigasset) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
> **VeniceHudConfigAsset**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [VeniceHudConfigAsset](/vext/ref/fb/venicehudconfigasset). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [VeniceHudConfigAsset](/vext/ref/fb/venicehudconfigasset). |
