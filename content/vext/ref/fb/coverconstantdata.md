...
| **[CoverConstantData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
| **[CoverConstantData](#constructor-2)**(other: [Asset](/vext/ref/fb/asset)) |
| **[CoverConstantData](#constructor-3)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "CoverConstantData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **CoverConstantData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [CoverConstantData](/vext/ref/fb/coverconstantdata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [Asset](/vext/ref/fb/asset) to [CoverConstantData](/vext/ref/fb/coverconstantdata). Will throw an error when trying to cast from an unsupported type.
...
> **CoverConstantData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [CoverConstantData](/vext/ref/fb/coverconstantdata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [CoverConstantData](/vext/ref/fb/coverconstantdata). |
