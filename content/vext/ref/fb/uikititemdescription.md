...
| **[UIKitItemDescription](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
| **[UIKitItemDescription](#constructor-2)**(other: [UIItemDescription](/vext/ref/fb/uiitemdescription)) |
| **[UIKitItemDescription](#constructor-3)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "UIKitItemDescription" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **UIKitItemDescription**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [UIKitItemDescription](/vext/ref/fb/uikititemdescription) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [UIItemDescription](/vext/ref/fb/uiitemdescription) to [UIKitItemDescription](/vext/ref/fb/uikititemdescription). Will throw an error when trying to cast from an unsupported type.
...
> **UIKitItemDescription**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [UIKitItemDescription](/vext/ref/fb/uikititemdescription). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [UIKitItemDescription](/vext/ref/fb/uikititemdescription). |
