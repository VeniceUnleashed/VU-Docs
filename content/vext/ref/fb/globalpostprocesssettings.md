...
| **[GlobalPostProcessSettings](#constructor-1)**(guid: [Guid](/vext/ref/shared/class/guid)) |
| **[GlobalPostProcessSettings](#constructor-2)**(other: [DataContainer](/vext/ref/shared/class/datacontainer)) |

### Properties
| Name | Type |
| ---- | ---- |
| {{< prop "brightness" >}} | [Vec3](/vext/ref/shared/class/vec3) |
| {{< prop "forceBloomScale" >}} | [Vec3](/vext/ref/shared/class/vec3) |
| {{< prop "forceVignetteColor" >}} | [Vec4](/vext/ref/shared/class/vec4) |
| {{< prop "contrast" >}} | [Vec3](/vext/ref/shared/class/vec3) |
| {{< prop "saturation" >}} | [Vec3](/vext/ref/shared/class/vec3) |
| {{< prop "filmGrainTextureScale" >}} | [Vec2](/vext/ref/shared/class/vec2) |
| {{< prop "forceVignetteScale" >}} | [Vec2](/vext/ref/shared/class/vec2) |
| {{< prop "filmGrainColorScale" >}} | [Vec3](/vext/ref/shared/class/vec3) |
...
| Name | Type |
| ---- | ---- |
| {{< static "GlobalPostProcessSettings" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/class/typeinformation) |
...
> **GlobalPostProcessSettings**(guid: [Guid](/vext/ref/shared/class/guid))

Creates a new [GlobalPostProcessSettings](/vext/ref/fb/globalpostprocesssettings) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/class/guid).
...
> **GlobalPostProcessSettings**(other: [DataContainer](/vext/ref/shared/class/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [GlobalPostProcessSettings](/vext/ref/fb/globalpostprocesssettings). Will throw an error when trying to cast from an invalid type.

#### Parameters
| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/class/datacontainer) | The instance to cast to [GlobalPostProcessSettings](/vext/ref/fb/globalpostprocesssettings). |
