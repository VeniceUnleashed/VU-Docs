...
| **[MeleeTriggerEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/class/guid)) |
...
| **[MeleeTriggerEntityData](#constructor-5)**(other: [DataContainer](/vext/ref/shared/class/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "MeleeTriggerEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/class/typeinformation) |
...
> **MeleeTriggerEntityData**(guid: [Guid](/vext/ref/shared/class/guid))

Creates a new [MeleeTriggerEntityData](/vext/ref/fb/meleetriggerentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/class/guid).
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [MeleeTriggerEntityData](/vext/ref/fb/meleetriggerentitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [MeleeTriggerEntityData](/vext/ref/fb/meleetriggerentitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [MeleeTriggerEntityData](/vext/ref/fb/meleetriggerentitydata). Will throw an error when trying to cast from an invalid type.
...
> **MeleeTriggerEntityData**(other: [DataContainer](/vext/ref/shared/class/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [MeleeTriggerEntityData](/vext/ref/fb/meleetriggerentitydata). Will throw an error when trying to cast from an invalid type.

#### Parameters
| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/class/datacontainer) | The instance to cast to [MeleeTriggerEntityData](/vext/ref/fb/meleetriggerentitydata). |
