...
| **[InputRestrictionEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[InputRestrictionEntityData](#constructor-7)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "InputRestrictionEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **InputRestrictionEntityData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [InputRestrictionEntityData](/vext/ref/fb/inputrestrictionentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [GameEntityData](/vext/ref/fb/gameentitydata) to [InputRestrictionEntityData](/vext/ref/fb/inputrestrictionentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [SpatialEntityData](/vext/ref/fb/spatialentitydata) to [InputRestrictionEntityData](/vext/ref/fb/inputrestrictionentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [InputRestrictionEntityData](/vext/ref/fb/inputrestrictionentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [InputRestrictionEntityData](/vext/ref/fb/inputrestrictionentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [InputRestrictionEntityData](/vext/ref/fb/inputrestrictionentitydata). Will throw an error when trying to cast from an unsupported type.
...
> **InputRestrictionEntityData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [InputRestrictionEntityData](/vext/ref/fb/inputrestrictionentitydata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [InputRestrictionEntityData](/vext/ref/fb/inputrestrictionentitydata). |
