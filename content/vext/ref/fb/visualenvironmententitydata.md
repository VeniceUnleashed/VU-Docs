...
| **[VisualEnvironmentEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/class/guid)) |
...
| **[VisualEnvironmentEntityData](#constructor-7)**(other: [DataContainer](/vext/ref/shared/class/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "VisualEnvironmentEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/class/typeinformation) |
...
> **VisualEnvironmentEntityData**(guid: [Guid](/vext/ref/shared/class/guid))

Creates a new [VisualEnvironmentEntityData](/vext/ref/fb/visualenvironmententitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/class/guid).
...
Casts an instance of type [GameEntityData](/vext/ref/fb/gameentitydata) to [VisualEnvironmentEntityData](/vext/ref/fb/visualenvironmententitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [SpatialEntityData](/vext/ref/fb/spatialentitydata) to [VisualEnvironmentEntityData](/vext/ref/fb/visualenvironmententitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [VisualEnvironmentEntityData](/vext/ref/fb/visualenvironmententitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [VisualEnvironmentEntityData](/vext/ref/fb/visualenvironmententitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [VisualEnvironmentEntityData](/vext/ref/fb/visualenvironmententitydata). Will throw an error when trying to cast from an invalid type.
...
> **VisualEnvironmentEntityData**(other: [DataContainer](/vext/ref/shared/class/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [VisualEnvironmentEntityData](/vext/ref/fb/visualenvironmententitydata). Will throw an error when trying to cast from an invalid type.

#### Parameters
| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/class/datacontainer) | The instance to cast to [VisualEnvironmentEntityData](/vext/ref/fb/visualenvironmententitydata). |
