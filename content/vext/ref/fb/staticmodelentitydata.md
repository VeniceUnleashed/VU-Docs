...
| **[StaticModelEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[StaticModelEntityData](#constructor-8)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| {{< prop "boneCount" >}} | int |
| {{< prop "basePoseTransforms" >}} | [LinearTransform](/vext/ref/shared/type/lineartransform)[] |
...
| Name | Type |
| ---- | ---- |
| {{< static "StaticModelEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **StaticModelEntityData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [StaticModelEntityData](/vext/ref/fb/staticmodelentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [GamePhysicsEntityData](/vext/ref/fb/gamephysicsentitydata) to [StaticModelEntityData](/vext/ref/fb/staticmodelentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameEntityData](/vext/ref/fb/gameentitydata) to [StaticModelEntityData](/vext/ref/fb/staticmodelentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [SpatialEntityData](/vext/ref/fb/spatialentitydata) to [StaticModelEntityData](/vext/ref/fb/staticmodelentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [StaticModelEntityData](/vext/ref/fb/staticmodelentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [StaticModelEntityData](/vext/ref/fb/staticmodelentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [StaticModelEntityData](/vext/ref/fb/staticmodelentitydata). Will throw an error when trying to cast from an unsupported type.
...
> **StaticModelEntityData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [StaticModelEntityData](/vext/ref/fb/staticmodelentitydata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [StaticModelEntityData](/vext/ref/fb/staticmodelentitydata). |
