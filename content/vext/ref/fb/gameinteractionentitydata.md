...
Inherits from [InteractionEntityData](/vext/ref/fb/interactionentitydata)
...
| **[GameInteractionEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[GameInteractionEntityData](#constructor-8)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "GameInteractionEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **GameInteractionEntityData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [GameInteractionEntityData](/vext/ref/fb/gameinteractionentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [InteractionEntityData](/vext/ref/fb/interactionentitydata) to [GameInteractionEntityData](/vext/ref/fb/gameinteractionentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameEntityData](/vext/ref/fb/gameentitydata) to [GameInteractionEntityData](/vext/ref/fb/gameinteractionentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [SpatialEntityData](/vext/ref/fb/spatialentitydata) to [GameInteractionEntityData](/vext/ref/fb/gameinteractionentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [GameInteractionEntityData](/vext/ref/fb/gameinteractionentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [GameInteractionEntityData](/vext/ref/fb/gameinteractionentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [GameInteractionEntityData](/vext/ref/fb/gameinteractionentitydata). Will throw an error when trying to cast from an unsupported type.
...
> **GameInteractionEntityData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [GameInteractionEntityData](/vext/ref/fb/gameinteractionentitydata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [GameInteractionEntityData](/vext/ref/fb/gameinteractionentitydata). |
