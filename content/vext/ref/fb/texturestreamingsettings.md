...
| **[TextureStreamingSettings](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
| **[TextureStreamingSettings](#constructor-2)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "TextureStreamingSettings" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **TextureStreamingSettings**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [TextureStreamingSettings](/vext/ref/fb/texturestreamingsettings) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
> **TextureStreamingSettings**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [TextureStreamingSettings](/vext/ref/fb/texturestreamingsettings). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [TextureStreamingSettings](/vext/ref/fb/texturestreamingsettings). |
