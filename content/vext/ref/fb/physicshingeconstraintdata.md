...
| **[PhysicsHingeConstraintData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[PhysicsHingeConstraintData](#constructor-5)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "PhysicsHingeConstraintData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **PhysicsHingeConstraintData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [PhysicsHingeConstraintData](/vext/ref/fb/physicshingeconstraintdata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [PhysicsConstraintData](/vext/ref/fb/physicsconstraintdata) to [PhysicsHingeConstraintData](/vext/ref/fb/physicshingeconstraintdata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [PhysicsHingeConstraintData](/vext/ref/fb/physicshingeconstraintdata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [PhysicsHingeConstraintData](/vext/ref/fb/physicshingeconstraintdata). Will throw an error when trying to cast from an unsupported type.
...
> **PhysicsHingeConstraintData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [PhysicsHingeConstraintData](/vext/ref/fb/physicshingeconstraintdata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [PhysicsHingeConstraintData](/vext/ref/fb/physicshingeconstraintdata). |
