...
| **[SurroundingGeometryEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[SurroundingGeometryEntityData](#constructor-7)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "SurroundingGeometryEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **SurroundingGeometryEntityData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [SurroundingGeometryEntityData](/vext/ref/fb/surroundinggeometryentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [GameEntityData](/vext/ref/fb/gameentitydata) to [SurroundingGeometryEntityData](/vext/ref/fb/surroundinggeometryentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [SpatialEntityData](/vext/ref/fb/spatialentitydata) to [SurroundingGeometryEntityData](/vext/ref/fb/surroundinggeometryentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [SurroundingGeometryEntityData](/vext/ref/fb/surroundinggeometryentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [SurroundingGeometryEntityData](/vext/ref/fb/surroundinggeometryentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [SurroundingGeometryEntityData](/vext/ref/fb/surroundinggeometryentitydata). Will throw an error when trying to cast from an unsupported type.
...
> **SurroundingGeometryEntityData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [SurroundingGeometryEntityData](/vext/ref/fb/surroundinggeometryentitydata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [SurroundingGeometryEntityData](/vext/ref/fb/surroundinggeometryentitydata). |
