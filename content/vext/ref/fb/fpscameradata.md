...
| **[FPSCameraData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[FPSCameraData](#constructor-6)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "FPSCameraData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **FPSCameraData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [FPSCameraData](/vext/ref/fb/fpscameradata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [TargetCameraData](/vext/ref/fb/targetcameradata) to [FPSCameraData](/vext/ref/fb/fpscameradata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [CameraData](/vext/ref/fb/cameradata) to [FPSCameraData](/vext/ref/fb/fpscameradata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [FPSCameraData](/vext/ref/fb/fpscameradata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [FPSCameraData](/vext/ref/fb/fpscameradata). Will throw an error when trying to cast from an unsupported type.
...
> **FPSCameraData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [FPSCameraData](/vext/ref/fb/fpscameradata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [FPSCameraData](/vext/ref/fb/fpscameradata). |
