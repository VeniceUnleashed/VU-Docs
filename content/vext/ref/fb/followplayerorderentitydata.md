...
| **[FollowPlayerOrderEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[FollowPlayerOrderEntityData](#constructor-7)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "FollowPlayerOrderEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **FollowPlayerOrderEntityData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [FollowPlayerOrderEntityData](/vext/ref/fb/followplayerorderentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [BFOrderEntityData](/vext/ref/fb/bforderentitydata) to [FollowPlayerOrderEntityData](/vext/ref/fb/followplayerorderentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [OrderEntityData](/vext/ref/fb/orderentitydata) to [FollowPlayerOrderEntityData](/vext/ref/fb/followplayerorderentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [FollowPlayerOrderEntityData](/vext/ref/fb/followplayerorderentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [FollowPlayerOrderEntityData](/vext/ref/fb/followplayerorderentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [FollowPlayerOrderEntityData](/vext/ref/fb/followplayerorderentitydata). Will throw an error when trying to cast from an unsupported type.
...
> **FollowPlayerOrderEntityData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [FollowPlayerOrderEntityData](/vext/ref/fb/followplayerorderentitydata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [FollowPlayerOrderEntityData](/vext/ref/fb/followplayerorderentitydata). |
