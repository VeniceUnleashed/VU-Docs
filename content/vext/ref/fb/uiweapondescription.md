...
| **[UIWeaponDescription](#constructor-1)**(guid: [Guid](/vext/ref/shared/class/guid)) |
| **[UIWeaponDescription](#constructor-2)**(other: [UIItemDescription](/vext/ref/fb/uiitemdescription)) |
| **[UIWeaponDescription](#constructor-3)**(other: [DataContainer](/vext/ref/shared/class/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "UIWeaponDescription" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/class/typeinformation) |
...
> **UIWeaponDescription**(guid: [Guid](/vext/ref/shared/class/guid))

Creates a new [UIWeaponDescription](/vext/ref/fb/uiweapondescription) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/class/guid).
...
Casts an instance of type [UIItemDescription](/vext/ref/fb/uiitemdescription) to [UIWeaponDescription](/vext/ref/fb/uiweapondescription). Will throw an error when trying to cast from an invalid type.
...
> **UIWeaponDescription**(other: [DataContainer](/vext/ref/shared/class/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [UIWeaponDescription](/vext/ref/fb/uiweapondescription). Will throw an error when trying to cast from an invalid type.

#### Parameters
| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/class/datacontainer) | The instance to cast to [UIWeaponDescription](/vext/ref/fb/uiweapondescription). |
