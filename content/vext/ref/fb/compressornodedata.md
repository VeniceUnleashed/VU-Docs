...
| **[CompressorNodeData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
| **[CompressorNodeData](#constructor-2)**(other: [AudioGraphNodeData](/vext/ref/fb/audiographnodedata)) |
| **[CompressorNodeData](#constructor-3)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "CompressorNodeData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **CompressorNodeData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [CompressorNodeData](/vext/ref/fb/compressornodedata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [AudioGraphNodeData](/vext/ref/fb/audiographnodedata) to [CompressorNodeData](/vext/ref/fb/compressornodedata). Will throw an error when trying to cast from an unsupported type.
...
> **CompressorNodeData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [CompressorNodeData](/vext/ref/fb/compressornodedata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [CompressorNodeData](/vext/ref/fb/compressornodedata). |
