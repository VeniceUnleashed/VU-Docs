...
| **[SunFlareEffectState](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
| **[SunFlareEffectState](#constructor-2)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "SunFlareEffectState" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **SunFlareEffectState**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [SunFlareEffectState](/vext/ref/fb/sunflareeffectstate) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
> **SunFlareEffectState**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [SunFlareEffectState](/vext/ref/fb/sunflareeffectstate). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [SunFlareEffectState](/vext/ref/fb/sunflareeffectstate). |
