...
| **[DebugTextEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[DebugTextEntityData](#constructor-6)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "DebugTextEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **DebugTextEntityData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [DebugTextEntityData](/vext/ref/fb/debugtextentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [SpatialEntityData](/vext/ref/fb/spatialentitydata) to [DebugTextEntityData](/vext/ref/fb/debugtextentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [DebugTextEntityData](/vext/ref/fb/debugtextentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [DebugTextEntityData](/vext/ref/fb/debugtextentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [DebugTextEntityData](/vext/ref/fb/debugtextentitydata). Will throw an error when trying to cast from an unsupported type.
...
> **DebugTextEntityData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [DebugTextEntityData](/vext/ref/fb/debugtextentitydata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [DebugTextEntityData](/vext/ref/fb/debugtextentitydata). |
