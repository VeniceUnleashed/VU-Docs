...
| **[CameraParamsComponentData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[CameraParamsComponentData](#constructor-5)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "CameraParamsComponentData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **CameraParamsComponentData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [CameraParamsComponentData](/vext/ref/fb/cameraparamscomponentdata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [ComponentData](/vext/ref/fb/componentdata) to [CameraParamsComponentData](/vext/ref/fb/cameraparamscomponentdata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [CameraParamsComponentData](/vext/ref/fb/cameraparamscomponentdata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [CameraParamsComponentData](/vext/ref/fb/cameraparamscomponentdata). Will throw an error when trying to cast from an unsupported type.
...
> **CameraParamsComponentData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [CameraParamsComponentData](/vext/ref/fb/cameraparamscomponentdata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [CameraParamsComponentData](/vext/ref/fb/cameraparamscomponentdata). |
