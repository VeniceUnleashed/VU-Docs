...
Inherits from [SoldierWeaponBlueprint](/vext/ref/fb/soldierweaponblueprint)
...
| **[SoldierWeaponAsset](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[SoldierWeaponAsset](#constructor-8)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |

### Static members

| Name | Type |
| ---- | ---- |
| {{< static "SoldierWeaponAsset" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **SoldierWeaponAsset**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [SoldierWeaponAsset](/vext/ref/fb/soldierweaponasset) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [SoldierWeaponBlueprint](/vext/ref/fb/soldierweaponblueprint) to [SoldierWeaponAsset](/vext/ref/fb/soldierweaponasset). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [ObjectBlueprint](/vext/ref/fb/objectblueprint) to [SoldierWeaponAsset](/vext/ref/fb/soldierweaponasset). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [Blueprint](/vext/ref/fb/blueprint) to [SoldierWeaponAsset](/vext/ref/fb/soldierweaponasset). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [EntityBusData](/vext/ref/fb/entitybusdata) to [SoldierWeaponAsset](/vext/ref/fb/soldierweaponasset). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [DataBusData](/vext/ref/fb/databusdata) to [SoldierWeaponAsset](/vext/ref/fb/soldierweaponasset). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [Asset](/vext/ref/fb/asset) to [SoldierWeaponAsset](/vext/ref/fb/soldierweaponasset). Will throw an error when trying to cast from an unsupported type.
...
> **SoldierWeaponAsset**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [SoldierWeaponAsset](/vext/ref/fb/soldierweaponasset). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [SoldierWeaponAsset](/vext/ref/fb/soldierweaponasset). |
