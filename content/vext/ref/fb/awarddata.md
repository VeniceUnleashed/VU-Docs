...
Inherits from [AbstractAwardData](/vext/ref/fb/abstractawarddata)
...
| **[AwardData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[AwardData](#constructor-4)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "AwardData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **AwardData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [AwardData](/vext/ref/fb/awarddata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [AbstractAwardData](/vext/ref/fb/abstractawarddata) to [AwardData](/vext/ref/fb/awarddata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [TreeNodeBase](/vext/ref/fb/treenodebase) to [AwardData](/vext/ref/fb/awarddata). Will throw an error when trying to cast from an unsupported type.
...
> **AwardData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [AwardData](/vext/ref/fb/awarddata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [AwardData](/vext/ref/fb/awarddata). |
