...
| **[ServerSettings](#constructor-1)**(guid: [Guid](/vext/ref/shared/class/guid)) |
| **[ServerSettings](#constructor-2)**(other: [SystemSettings](/vext/ref/fb/systemsettings)) |
| **[ServerSettings](#constructor-3)**(other: [DataContainer](/vext/ref/shared/class/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "ServerSettings" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/class/typeinformation) |
...
> **ServerSettings**(guid: [Guid](/vext/ref/shared/class/guid))

Creates a new [ServerSettings](/vext/ref/fb/serversettings) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/class/guid).
...
Casts an instance of type [SystemSettings](/vext/ref/fb/systemsettings) to [ServerSettings](/vext/ref/fb/serversettings). Will throw an error when trying to cast from an invalid type.
...
> **ServerSettings**(other: [DataContainer](/vext/ref/shared/class/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [ServerSettings](/vext/ref/fb/serversettings). Will throw an error when trying to cast from an invalid type.

#### Parameters
| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/class/datacontainer) | The instance to cast to [ServerSettings](/vext/ref/fb/serversettings). |
