...
| **[AnimatedDriverEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[AnimatedDriverEntityData](#constructor-7)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |

### Properties

| Name | Type |
| ---- | ---- |
| {{< prop "inputTransform" >}} | [LinearTransform](/vext/ref/shared/type/lineartransform) |
...
| Name | Type |
| ---- | ---- |
| {{< static "AnimatedDriverEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **AnimatedDriverEntityData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [AnimatedDriverEntityData](/vext/ref/fb/animateddriverentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [GameEntityData](/vext/ref/fb/gameentitydata) to [AnimatedDriverEntityData](/vext/ref/fb/animateddriverentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [SpatialEntityData](/vext/ref/fb/spatialentitydata) to [AnimatedDriverEntityData](/vext/ref/fb/animateddriverentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [AnimatedDriverEntityData](/vext/ref/fb/animateddriverentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [AnimatedDriverEntityData](/vext/ref/fb/animateddriverentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [AnimatedDriverEntityData](/vext/ref/fb/animateddriverentitydata). Will throw an error when trying to cast from an unsupported type.
...
> **AnimatedDriverEntityData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [AnimatedDriverEntityData](/vext/ref/fb/animateddriverentitydata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [AnimatedDriverEntityData](/vext/ref/fb/animateddriverentitydata). |
