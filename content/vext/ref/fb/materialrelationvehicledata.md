...
| **[MaterialRelationVehicleData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[MaterialRelationVehicleData](#constructor-4)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "MaterialRelationVehicleData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **MaterialRelationVehicleData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [MaterialRelationVehicleData](/vext/ref/fb/materialrelationvehicledata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [PhysicsMaterialRelationPropertyData](/vext/ref/fb/physicsmaterialrelationpropertydata) to [MaterialRelationVehicleData](/vext/ref/fb/materialrelationvehicledata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [MaterialRelationPropertyData](/vext/ref/fb/materialrelationpropertydata) to [MaterialRelationVehicleData](/vext/ref/fb/materialrelationvehicledata). Will throw an error when trying to cast from an unsupported type.
...
> **MaterialRelationVehicleData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [MaterialRelationVehicleData](/vext/ref/fb/materialrelationvehicledata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [MaterialRelationVehicleData](/vext/ref/fb/materialrelationvehicledata). |
