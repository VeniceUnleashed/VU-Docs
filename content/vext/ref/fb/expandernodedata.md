...
| **[ExpanderNodeData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
| **[ExpanderNodeData](#constructor-2)**(other: [AudioGraphNodeData](/vext/ref/fb/audiographnodedata)) |
| **[ExpanderNodeData](#constructor-3)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "ExpanderNodeData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **ExpanderNodeData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [ExpanderNodeData](/vext/ref/fb/expandernodedata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [AudioGraphNodeData](/vext/ref/fb/audiographnodedata) to [ExpanderNodeData](/vext/ref/fb/expandernodedata). Will throw an error when trying to cast from an unsupported type.
...
> **ExpanderNodeData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [ExpanderNodeData](/vext/ref/fb/expandernodedata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [ExpanderNodeData](/vext/ref/fb/expandernodedata). |
