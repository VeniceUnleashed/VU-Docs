...
| **[VegetationBaseEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[VegetationBaseEntityData](#constructor-7)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| {{< prop "basePoseTranslations" >}} | [Vec3](/vext/ref/shared/type/vec3)[] |
| {{< prop "hierarchy" >}} | int[] |
...
| Name | Type |
| ---- | ---- |
| {{< static "VegetationBaseEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **VegetationBaseEntityData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [VegetationBaseEntityData](/vext/ref/fb/vegetationbaseentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [GameEntityData](/vext/ref/fb/gameentitydata) to [VegetationBaseEntityData](/vext/ref/fb/vegetationbaseentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [SpatialEntityData](/vext/ref/fb/spatialentitydata) to [VegetationBaseEntityData](/vext/ref/fb/vegetationbaseentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [VegetationBaseEntityData](/vext/ref/fb/vegetationbaseentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [VegetationBaseEntityData](/vext/ref/fb/vegetationbaseentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [VegetationBaseEntityData](/vext/ref/fb/vegetationbaseentitydata). Will throw an error when trying to cast from an unsupported type.
...
> **VegetationBaseEntityData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [VegetationBaseEntityData](/vext/ref/fb/vegetationbaseentitydata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [VegetationBaseEntityData](/vext/ref/fb/vegetationbaseentitydata). |
