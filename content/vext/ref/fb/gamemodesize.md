...
| **[GameModeSize](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "GameModeSize" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
Creates a new [GameModeSize](/vext/ref/fb/gamemodesize) frostbite instance.

### GameModeSize {#constructor-1}

> **GameModeSize**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [GameModeSize](/vext/ref/fb/gamemodesize) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
