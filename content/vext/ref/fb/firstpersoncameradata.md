...
| **[FirstPersonCameraData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
| **[FirstPersonCameraData](#constructor-2)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| {{< prop "weaponBaseOffset" >}} | [Vec3](/vext/ref/shared/type/vec3) |
| {{< prop "weaponLagRotationOffset" >}} | [Vec3](/vext/ref/shared/type/vec3) |
...
| Name | Type |
| ---- | ---- |
| {{< static "FirstPersonCameraData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **FirstPersonCameraData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [FirstPersonCameraData](/vext/ref/fb/firstpersoncameradata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
> **FirstPersonCameraData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [FirstPersonCameraData](/vext/ref/fb/firstpersoncameradata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [FirstPersonCameraData](/vext/ref/fb/firstpersoncameradata). |
