...
| **[WheelConfigData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
| **[WheelConfigData](#constructor-2)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| {{< prop "inertia" >}} | [Vec3](/vext/ref/shared/type/vec3) |
...
| {{< prop "transmissionLoss" >}} | [Vec2](/vext/ref/shared/type/vec2)[] |
...
| Name | Type |
| ---- | ---- |
| {{< static "WheelConfigData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **WheelConfigData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [WheelConfigData](/vext/ref/fb/wheelconfigdata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
> **WheelConfigData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [WheelConfigData](/vext/ref/fb/wheelconfigdata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [WheelConfigData](/vext/ref/fb/wheelconfigdata). |
