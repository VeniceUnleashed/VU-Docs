...
| **[LakeData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[LakeData](#constructor-7)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |

### Static members

| Name | Type |
| ---- | ---- |
| {{< static "LakeData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **LakeData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [LakeData](/vext/ref/fb/lakedata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [VisualVectorShapeData](/vext/ref/fb/visualvectorshapedata) to [LakeData](/vext/ref/fb/lakedata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [VectorShapeData](/vext/ref/fb/vectorshapedata) to [LakeData](/vext/ref/fb/lakedata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [BaseShapeData](/vext/ref/fb/baseshapedata) to [LakeData](/vext/ref/fb/lakedata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [LakeData](/vext/ref/fb/lakedata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [LakeData](/vext/ref/fb/lakedata). Will throw an error when trying to cast from an unsupported type.
...
> **LakeData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [LakeData](/vext/ref/fb/lakedata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [LakeData](/vext/ref/fb/lakedata). |
