...
| ShaderSystemSettings([DataContainer](/vext/ref/shared/class/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [ShaderSystemSettings](/vext/ref/fb/shadersystemsettings/). |
...
| -------------------------------------------- | --------------- | ---------------------------------------------- |
| [ShaderSystemSettings](/vext/ref/fb/shadersystemsettings/) | [Clone](#clone) | \[[Guid](/vext/ref/shared/class/guid) **guid**\] |

### Clone

> [ShaderSystemSettings](/vext/ref/fb/shadersystemsettings/) **Clone**(\[[Guid](/vext/ref/shared/class/guid) **guid**\])
