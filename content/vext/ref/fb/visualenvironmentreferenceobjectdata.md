...
| **[VisualEnvironmentReferenceObjectData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[VisualEnvironmentReferenceObjectData](#constructor-5)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "VisualEnvironmentReferenceObjectData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **VisualEnvironmentReferenceObjectData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [VisualEnvironmentReferenceObjectData](/vext/ref/fb/visualenvironmentreferenceobjectdata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [ReferenceObjectData](/vext/ref/fb/referenceobjectdata) to [VisualEnvironmentReferenceObjectData](/vext/ref/fb/visualenvironmentreferenceobjectdata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [VisualEnvironmentReferenceObjectData](/vext/ref/fb/visualenvironmentreferenceobjectdata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [VisualEnvironmentReferenceObjectData](/vext/ref/fb/visualenvironmentreferenceobjectdata). Will throw an error when trying to cast from an unsupported type.
...
> **VisualEnvironmentReferenceObjectData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [VisualEnvironmentReferenceObjectData](/vext/ref/fb/visualenvironmentreferenceobjectdata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [VisualEnvironmentReferenceObjectData](/vext/ref/fb/visualenvironmentreferenceobjectdata). |
