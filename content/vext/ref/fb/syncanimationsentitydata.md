...
| **[SyncAnimationsEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/class/guid)) |
...
| **[SyncAnimationsEntityData](#constructor-5)**(other: [DataContainer](/vext/ref/shared/class/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "SyncAnimationsEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/class/typeinformation) |
...
> **SyncAnimationsEntityData**(guid: [Guid](/vext/ref/shared/class/guid))

Creates a new [SyncAnimationsEntityData](/vext/ref/fb/syncanimationsentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/class/guid).
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [SyncAnimationsEntityData](/vext/ref/fb/syncanimationsentitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [SyncAnimationsEntityData](/vext/ref/fb/syncanimationsentitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [SyncAnimationsEntityData](/vext/ref/fb/syncanimationsentitydata). Will throw an error when trying to cast from an invalid type.
...
> **SyncAnimationsEntityData**(other: [DataContainer](/vext/ref/shared/class/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [SyncAnimationsEntityData](/vext/ref/fb/syncanimationsentitydata). Will throw an error when trying to cast from an invalid type.

#### Parameters
| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/class/datacontainer) | The instance to cast to [SyncAnimationsEntityData](/vext/ref/fb/syncanimationsentitydata). |
