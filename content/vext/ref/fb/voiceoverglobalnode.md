...
| **[VoiceOverGlobalNode](#constructor-1)**(guid: [Guid](/vext/ref/shared/class/guid)) |
...
| **[VoiceOverGlobalNode](#constructor-4)**(other: [DataContainer](/vext/ref/shared/class/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "VoiceOverGlobalNode" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/class/typeinformation) |
...
> **VoiceOverGlobalNode**(guid: [Guid](/vext/ref/shared/class/guid))

Creates a new [VoiceOverGlobalNode](/vext/ref/fb/voiceoverglobalnode) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/class/guid).
...
Casts an instance of type [VoiceOverExpressionNode](/vext/ref/fb/voiceoverexpressionnode) to [VoiceOverGlobalNode](/vext/ref/fb/voiceoverglobalnode). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [VoiceOverNode](/vext/ref/fb/voiceovernode) to [VoiceOverGlobalNode](/vext/ref/fb/voiceoverglobalnode). Will throw an error when trying to cast from an invalid type.
...
> **VoiceOverGlobalNode**(other: [DataContainer](/vext/ref/shared/class/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [VoiceOverGlobalNode](/vext/ref/fb/voiceoverglobalnode). Will throw an error when trying to cast from an invalid type.

#### Parameters
| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/class/datacontainer) | The instance to cast to [VoiceOverGlobalNode](/vext/ref/fb/voiceoverglobalnode). |
