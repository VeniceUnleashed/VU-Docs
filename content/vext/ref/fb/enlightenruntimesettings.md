...
| **[EnlightenRuntimeSettings](#constructor-1)**(guid: [Guid](/vext/ref/shared/class/guid)) |
| **[EnlightenRuntimeSettings](#constructor-2)**(other: [SystemSettings](/vext/ref/fb/systemsettings)) |
| **[EnlightenRuntimeSettings](#constructor-3)**(other: [DataContainer](/vext/ref/shared/class/datacontainer)) |

### Properties
| Name | Type |
| ---- | ---- |
| {{< prop "albedoDefaultColor" >}} | [Vec3](/vext/ref/shared/class/vec3) |
...
| Name | Type |
| ---- | ---- |
| {{< static "EnlightenRuntimeSettings" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/class/typeinformation) |
...
> **EnlightenRuntimeSettings**(guid: [Guid](/vext/ref/shared/class/guid))

Creates a new [EnlightenRuntimeSettings](/vext/ref/fb/enlightenruntimesettings) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/class/guid).
...
Casts an instance of type [SystemSettings](/vext/ref/fb/systemsettings) to [EnlightenRuntimeSettings](/vext/ref/fb/enlightenruntimesettings). Will throw an error when trying to cast from an invalid type.
...
> **EnlightenRuntimeSettings**(other: [DataContainer](/vext/ref/shared/class/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [EnlightenRuntimeSettings](/vext/ref/fb/enlightenruntimesettings). Will throw an error when trying to cast from an invalid type.

#### Parameters
| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/class/datacontainer) | The instance to cast to [EnlightenRuntimeSettings](/vext/ref/fb/enlightenruntimesettings). |
