...
| **[VehicleEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/class/guid)) |
...
| **[VehicleEntityData](#constructor-9)**(other: [DataContainer](/vext/ref/shared/class/datacontainer)) |

### Properties
| Name | Type |
| ---- | ---- |
| {{< prop "criticallyDamagedEffectPosition" >}} | [Vec3](/vext/ref/shared/class/vec3) |
| {{< prop "flirKeyColor" >}} | [Vec3](/vext/ref/shared/class/vec3) |
| {{< prop "preExplosionEffectPosition" >}} | [Vec3](/vext/ref/shared/class/vec3) |
| {{< prop "interactionOffset" >}} | [Vec3](/vext/ref/shared/class/vec3) |
...
| Name | Type |
| ---- | ---- |
| {{< static "VehicleEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/class/typeinformation) |
...
> **VehicleEntityData**(guid: [Guid](/vext/ref/shared/class/guid))

Creates a new [VehicleEntityData](/vext/ref/fb/vehicleentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/class/guid).
...
Casts an instance of type [ControllableEntityData](/vext/ref/fb/controllableentitydata) to [VehicleEntityData](/vext/ref/fb/vehicleentitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [GamePhysicsEntityData](/vext/ref/fb/gamephysicsentitydata) to [VehicleEntityData](/vext/ref/fb/vehicleentitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [GameEntityData](/vext/ref/fb/gameentitydata) to [VehicleEntityData](/vext/ref/fb/vehicleentitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [SpatialEntityData](/vext/ref/fb/spatialentitydata) to [VehicleEntityData](/vext/ref/fb/vehicleentitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [VehicleEntityData](/vext/ref/fb/vehicleentitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [VehicleEntityData](/vext/ref/fb/vehicleentitydata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [VehicleEntityData](/vext/ref/fb/vehicleentitydata). Will throw an error when trying to cast from an invalid type.
...
> **VehicleEntityData**(other: [DataContainer](/vext/ref/shared/class/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [VehicleEntityData](/vext/ref/fb/vehicleentitydata). Will throw an error when trying to cast from an invalid type.

#### Parameters
| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/class/datacontainer) | The instance to cast to [VehicleEntityData](/vext/ref/fb/vehicleentitydata). |
