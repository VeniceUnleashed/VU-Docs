...
| **[StaticCameraData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[StaticCameraData](#constructor-6)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |

### Properties

| Name | Type |
| ---- | ---- |
| {{< prop "leftCurve" >}} | [Vec3](/vext/ref/shared/type/vec3)[] |
| {{< prop "rightCurve" >}} | [Vec3](/vext/ref/shared/type/vec3)[] |
| {{< prop "upCurve" >}} | [Vec3](/vext/ref/shared/type/vec3)[] |
| {{< prop "downCurve" >}} | [Vec3](/vext/ref/shared/type/vec3)[] |
...
| Name | Type |
| ---- | ---- |
| {{< static "StaticCameraData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **StaticCameraData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [StaticCameraData](/vext/ref/fb/staticcameradata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [TargetCameraData](/vext/ref/fb/targetcameradata) to [StaticCameraData](/vext/ref/fb/staticcameradata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [CameraData](/vext/ref/fb/cameradata) to [StaticCameraData](/vext/ref/fb/staticcameradata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [StaticCameraData](/vext/ref/fb/staticcameradata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [StaticCameraData](/vext/ref/fb/staticcameradata). Will throw an error when trying to cast from an unsupported type.
...
> **StaticCameraData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [StaticCameraData](/vext/ref/fb/staticcameradata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [StaticCameraData](/vext/ref/fb/staticcameradata). |
