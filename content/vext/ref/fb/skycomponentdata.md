...
| **[SkyComponentData](#constructor-1)**(guid: [Guid](/vext/ref/shared/class/guid)) |
...
| **[SkyComponentData](#constructor-5)**(other: [DataContainer](/vext/ref/shared/class/datacontainer)) |

### Properties
| Name | Type |
| ---- | ---- |
| {{< prop "cloudLayerSunColor" >}} | [Vec3](/vext/ref/shared/class/vec3) |
| {{< prop "cloudLayer2Color" >}} | [Vec3](/vext/ref/shared/class/vec3) |
| {{< prop "cloudLayer1Color" >}} | [Vec3](/vext/ref/shared/class/vec3) |
...
| Name | Type |
| ---- | ---- |
| {{< static "SkyComponentData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/class/typeinformation) |
...
> **SkyComponentData**(guid: [Guid](/vext/ref/shared/class/guid))

Creates a new [SkyComponentData](/vext/ref/fb/skycomponentdata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/class/guid).
...
Casts an instance of type [ComponentData](/vext/ref/fb/componentdata) to [SkyComponentData](/vext/ref/fb/skycomponentdata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [SkyComponentData](/vext/ref/fb/skycomponentdata). Will throw an error when trying to cast from an invalid type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [SkyComponentData](/vext/ref/fb/skycomponentdata). Will throw an error when trying to cast from an invalid type.
...
> **SkyComponentData**(other: [DataContainer](/vext/ref/shared/class/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [SkyComponentData](/vext/ref/fb/skycomponentdata). Will throw an error when trying to cast from an invalid type.

#### Parameters
| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/class/datacontainer) | The instance to cast to [SkyComponentData](/vext/ref/fb/skycomponentdata). |
