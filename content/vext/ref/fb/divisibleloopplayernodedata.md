...
| **[DivisibleLoopPlayerNodeData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
| **[DivisibleLoopPlayerNodeData](#constructor-2)**(other: [AudioGraphNodeData](/vext/ref/fb/audiographnodedata)) |
| **[DivisibleLoopPlayerNodeData](#constructor-3)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "DivisibleLoopPlayerNodeData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **DivisibleLoopPlayerNodeData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [DivisibleLoopPlayerNodeData](/vext/ref/fb/divisibleloopplayernodedata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [AudioGraphNodeData](/vext/ref/fb/audiographnodedata) to [DivisibleLoopPlayerNodeData](/vext/ref/fb/divisibleloopplayernodedata). Will throw an error when trying to cast from an unsupported type.
...
> **DivisibleLoopPlayerNodeData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [DivisibleLoopPlayerNodeData](/vext/ref/fb/divisibleloopplayernodedata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [DivisibleLoopPlayerNodeData](/vext/ref/fb/divisibleloopplayernodedata). |
