...
| UIVehicleDescription([DataContainer](/vext/ref/shared/class/datacontainer) other) | Upcast an instance of type [DataContainer](/vext/ref/shared/class/datacontainer) to [UIVehicleDescription](UIVehicleDescription). |
...
| -------------------------------------------- | --------------- | ---------------------------------------------- |
| [UIVehicleDescription](UIVehicleDescription) | [Clone](#clone) | \[[Guid](/vext/ref/shared/class/guid) **guid**\] |

### Clone

> [UIVehicleDescription](UIVehicleDescription) **Clone**(\[[Guid](/vext/ref/shared/class/guid) **guid**\])
