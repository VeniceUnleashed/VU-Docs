...
| **[ChaseCameraData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[ChaseCameraData](#constructor-6)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| {{< prop "toWantedPositionScale" >}} | [Vec3](/vext/ref/shared/type/vec3) |
...
| Name | Type |
| ---- | ---- |
| {{< static "ChaseCameraData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **ChaseCameraData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [ChaseCameraData](/vext/ref/fb/chasecameradata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [TargetCameraData](/vext/ref/fb/targetcameradata) to [ChaseCameraData](/vext/ref/fb/chasecameradata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [CameraData](/vext/ref/fb/cameradata) to [ChaseCameraData](/vext/ref/fb/chasecameradata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [ChaseCameraData](/vext/ref/fb/chasecameradata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [ChaseCameraData](/vext/ref/fb/chasecameradata). Will throw an error when trying to cast from an unsupported type.
...
> **ChaseCameraData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [ChaseCameraData](/vext/ref/fb/chasecameradata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [ChaseCameraData](/vext/ref/fb/chasecameradata). |
