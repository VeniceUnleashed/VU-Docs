...
| **[ExplosionPackEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[ExplosionPackEntityData](#constructor-10)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "ExplosionPackEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **ExplosionPackEntityData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [ExplosionPackEntityData](/vext/ref/fb/explosionpackentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [MeshProjectileEntityData](/vext/ref/fb/meshprojectileentitydata) to [ExplosionPackEntityData](/vext/ref/fb/explosionpackentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [ProjectileEntityData](/vext/ref/fb/projectileentitydata) to [ExplosionPackEntityData](/vext/ref/fb/explosionpackentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GamePhysicsEntityData](/vext/ref/fb/gamephysicsentitydata) to [ExplosionPackEntityData](/vext/ref/fb/explosionpackentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameEntityData](/vext/ref/fb/gameentitydata) to [ExplosionPackEntityData](/vext/ref/fb/explosionpackentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [SpatialEntityData](/vext/ref/fb/spatialentitydata) to [ExplosionPackEntityData](/vext/ref/fb/explosionpackentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [ExplosionPackEntityData](/vext/ref/fb/explosionpackentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [ExplosionPackEntityData](/vext/ref/fb/explosionpackentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [ExplosionPackEntityData](/vext/ref/fb/explosionpackentitydata). Will throw an error when trying to cast from an unsupported type.
...
> **ExplosionPackEntityData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [ExplosionPackEntityData](/vext/ref/fb/explosionpackentitydata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [ExplosionPackEntityData](/vext/ref/fb/explosionpackentitydata). |
