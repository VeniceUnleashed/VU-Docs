...
| **[MeshProjectileEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[MeshProjectileEntityData](#constructor-9)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |

### Properties

| Name | Type |
| ---- | ---- |
| {{< prop "initialAngularVelocity" >}} | [Vec3](/vext/ref/shared/type/vec3) |
...
| Name | Type |
| ---- | ---- |
| {{< static "MeshProjectileEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **MeshProjectileEntityData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [MeshProjectileEntityData](/vext/ref/fb/meshprojectileentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [ProjectileEntityData](/vext/ref/fb/projectileentitydata) to [MeshProjectileEntityData](/vext/ref/fb/meshprojectileentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GamePhysicsEntityData](/vext/ref/fb/gamephysicsentitydata) to [MeshProjectileEntityData](/vext/ref/fb/meshprojectileentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameEntityData](/vext/ref/fb/gameentitydata) to [MeshProjectileEntityData](/vext/ref/fb/meshprojectileentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [SpatialEntityData](/vext/ref/fb/spatialentitydata) to [MeshProjectileEntityData](/vext/ref/fb/meshprojectileentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [MeshProjectileEntityData](/vext/ref/fb/meshprojectileentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [MeshProjectileEntityData](/vext/ref/fb/meshprojectileentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [MeshProjectileEntityData](/vext/ref/fb/meshprojectileentitydata). Will throw an error when trying to cast from an unsupported type.
...
> **MeshProjectileEntityData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [MeshProjectileEntityData](/vext/ref/fb/meshprojectileentitydata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [MeshProjectileEntityData](/vext/ref/fb/meshprojectileentitydata). |
