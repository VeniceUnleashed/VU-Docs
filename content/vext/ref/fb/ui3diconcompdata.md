...
| **[UI3dIconCompData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[UI3dIconCompData](#constructor-4)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |

### Properties

| Name | Type |
| ---- | ---- |
| {{< prop "pixelOffset" >}} | [Vec2](/vext/ref/shared/type/vec2) |
| {{< prop "iconSize" >}} | float |
...
| Name | Type |
| ---- | ---- |
| {{< static "UI3dIconCompData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **UI3dIconCompData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [UI3dIconCompData](/vext/ref/fb/ui3diconcompdata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [UIComponentData](/vext/ref/fb/uicomponentdata) to [UI3dIconCompData](/vext/ref/fb/ui3diconcompdata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [Asset](/vext/ref/fb/asset) to [UI3dIconCompData](/vext/ref/fb/ui3diconcompdata). Will throw an error when trying to cast from an unsupported type.
...
> **UI3dIconCompData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [UI3dIconCompData](/vext/ref/fb/ui3diconcompdata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [UI3dIconCompData](/vext/ref/fb/ui3diconcompdata). |
