...
| **[LifeCounterEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[LifeCounterEntityData](#constructor-7)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "LifeCounterEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **LifeCounterEntityData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [LifeCounterEntityData](/vext/ref/fb/lifecounterentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [GameEntityData](/vext/ref/fb/gameentitydata) to [LifeCounterEntityData](/vext/ref/fb/lifecounterentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [SpatialEntityData](/vext/ref/fb/spatialentitydata) to [LifeCounterEntityData](/vext/ref/fb/lifecounterentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [LifeCounterEntityData](/vext/ref/fb/lifecounterentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [LifeCounterEntityData](/vext/ref/fb/lifecounterentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [LifeCounterEntityData](/vext/ref/fb/lifecounterentitydata). Will throw an error when trying to cast from an unsupported type.
...
> **LifeCounterEntityData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [LifeCounterEntityData](/vext/ref/fb/lifecounterentitydata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [LifeCounterEntityData](/vext/ref/fb/lifecounterentitydata). |
