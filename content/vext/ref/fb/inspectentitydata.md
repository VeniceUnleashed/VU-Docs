...
| **[InspectEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[InspectEntityData](#constructor-7)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |

### Properties

| Name | Type |
| ---- | ---- |
| {{< prop "centerOffset" >}} | [Vec3](/vext/ref/shared/type/vec3) |
| {{< prop "uiName" >}} | string |
...
| Name | Type |
| ---- | ---- |
| {{< static "InspectEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **InspectEntityData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [InspectEntityData](/vext/ref/fb/inspectentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [GameEntityData](/vext/ref/fb/gameentitydata) to [InspectEntityData](/vext/ref/fb/inspectentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [SpatialEntityData](/vext/ref/fb/spatialentitydata) to [InspectEntityData](/vext/ref/fb/inspectentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [InspectEntityData](/vext/ref/fb/inspectentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [InspectEntityData](/vext/ref/fb/inspectentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [InspectEntityData](/vext/ref/fb/inspectentitydata). Will throw an error when trying to cast from an unsupported type.
...
> **InspectEntityData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [InspectEntityData](/vext/ref/fb/inspectentitydata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [InspectEntityData](/vext/ref/fb/inspectentitydata). |
