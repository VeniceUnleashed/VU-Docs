...
Inherits from [ProjectileEntityData](/vext/ref/fb/projectileentitydata)
...
| **[VehicleProjectileEntityData](#constructor-1)**(guid: [Guid](/vext/ref/shared/type/guid)) |
...
| **[VehicleProjectileEntityData](#constructor-9)**(other: [DataContainer](/vext/ref/shared/type/datacontainer)) |
...
| Name | Type |
| ---- | ---- |
| {{< static "VehicleProjectileEntityData" "typeInfo" >}} | [TypeInformation](/vext/ref/shared/type/typeinformation) |
...
> **VehicleProjectileEntityData**(guid: [Guid](/vext/ref/shared/type/guid))

Creates a new [VehicleProjectileEntityData](/vext/ref/fb/vehicleprojectileentitydata) frostbite instance and assigns it the provided [Guid](/vext/ref/shared/type/guid).
...
Casts an instance of type [ProjectileEntityData](/vext/ref/fb/projectileentitydata) to [VehicleProjectileEntityData](/vext/ref/fb/vehicleprojectileentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GamePhysicsEntityData](/vext/ref/fb/gamephysicsentitydata) to [VehicleProjectileEntityData](/vext/ref/fb/vehicleprojectileentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameEntityData](/vext/ref/fb/gameentitydata) to [VehicleProjectileEntityData](/vext/ref/fb/vehicleprojectileentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [SpatialEntityData](/vext/ref/fb/spatialentitydata) to [VehicleProjectileEntityData](/vext/ref/fb/vehicleprojectileentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [EntityData](/vext/ref/fb/entitydata) to [VehicleProjectileEntityData](/vext/ref/fb/vehicleprojectileentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameObjectData](/vext/ref/fb/gameobjectdata) to [VehicleProjectileEntityData](/vext/ref/fb/vehicleprojectileentitydata). Will throw an error when trying to cast from an unsupported type.
...
Casts an instance of type [GameDataContainer](/vext/ref/fb/gamedatacontainer) to [VehicleProjectileEntityData](/vext/ref/fb/vehicleprojectileentitydata). Will throw an error when trying to cast from an unsupported type.
...
> **VehicleProjectileEntityData**(other: [DataContainer](/vext/ref/shared/type/datacontainer))

Casts an instance of type [DataContainer](/vext/ref/shared/type/datacontainer) to [VehicleProjectileEntityData](/vext/ref/fb/vehicleprojectileentitydata). Will throw an error when trying to cast from an unsupported type.

#### Parameters

| Name | Type | Description |
| ---- | ---- | ----------- |
| **other** | [DataContainer](/vext/ref/shared/type/datacontainer) | The instance to cast to [VehicleProjectileEntityData](/vext/ref/fb/vehicleprojectileentitydata). |
